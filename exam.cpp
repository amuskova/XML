...
int main()
{
	...
	std::cout << "Ако желаете симулация без повторни опити въведете 'r'\n Ако желаете въпросите. които сте объркали да се запазват въведете произволен символ\n";
	char useless;
	std::cin >> useless;
...
/**/
	...
	Question q127("Методите за работа с атрибути на DOM Element интерфейса:");
